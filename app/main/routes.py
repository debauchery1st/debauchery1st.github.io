...
def user(username):
    ...
    next_url = url_for('main.user/{}'.format(username), page=posts.next_num) if posts.has_next else None
    prev_url = url_for('main.user/{}'.format(username), page=posts.prev_num) if posts.has_prev else None
