...
from app.utils import avatar_dicebear, avatar_robohash
...
class User(UserMixin, db.Model):
    ...
    def avatar(self):
        ...
        return avatar_dicebear("jdenticon", digest[12:])
    ...
    def default_avatar(*args, **kwargs):
        digest = md5(current_app.config.get('ANONYMOUS_SEED').encode('utf-8')).hexdigest()
